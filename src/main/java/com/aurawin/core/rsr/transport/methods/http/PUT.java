...
import static com.aurawin.core.solution.Table.RSR.HTTP.Method.Put;
...
public class PUT extends Item {
    ...
    public Result onProcess(Session ssn, Transport transport) {
        ...
        if (CredentialResult.Granted.contains(h.validateCredentials(ssn))) {
            h.methodState  = h.resourceUploaded(ssn);
            ...
            h.Response.Headers.Update(
                    ...
                    Security.buildChallenge(Table.Security.Mechanism.HTTP.Basic,h.Owner.Engine.Realm)
