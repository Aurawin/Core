...
public class Namespace {
    ...
    public static class Entities{
        public static class Plugin{
            public static final UniqueId Method = new UniqueId("com.aurawin.core.stored.plugin.method.$classname:$major$minor");
            public static String getMethodNamespace(String ClassName, String Major, String Minor){
        ...
        public static class Domain {
            public static class UserAccount{
                public static final UniqueId Avatar = new UniqueId("com.aurawin.core.stored.entities.domain.useraccount.avatar");
            }

            public static class Folder {
                public static final UniqueId Domain = new UniqueId("com.aurawin.core.stored.entities.domain.folder.domain");
                public static final UniqueId Social = new UniqueId("com.aurawin.core.stored.entities.domain.folder.social");
            }
            public static class Roster{
                public static final UniqueId Avatar = new UniqueId("com.aurawin.core.stored.entities.domain.roster.avatar");
            }
            public static class Network {
                public static final UniqueId ACL = new UniqueId("com.aurawin.core.stored.entities.domain.network.acl");
                public static final UniqueId Avatar = new UniqueId("com.aurawin.core.stored.entities.domain.network.avatar");
            }
        }
    }
